...
//       },[])
//   return (
//     product && <div className="grid grid-cols-2 gap-5">
       
//        <div className="flex flex-col gap-5">
//          <img src={product.images[selectedImageIndex]}
//          alt="" className="w-96 h-96 object-cover rounded-md"/>
...
//                     onClick={()=>setSelectedImageIndex(index)} src={image} alt="" />
        ...
        <div className="grid grid-cols-2 gap-5 mt-5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-between mt-2">
                <span>Price</span>
                <span>{product.price} <i class="ri-money-rupee-circle-line"></i></span>
              </div>
              <div className="flex justify-between mt-2">
                <span>Category</span>
                  ...
                  return (
                    <div className="border border-gray-300 border-solid p-3 rounded mt-5">
                      ...
                      <div className="flex justify-between text-gray-600">
                        ...
                        <span> {bid.bidAmount}  <i class="ri-money-rupee-circle-line "></i></span>
                      </div>
                      <div className="flex justify-between text-gray-600">
